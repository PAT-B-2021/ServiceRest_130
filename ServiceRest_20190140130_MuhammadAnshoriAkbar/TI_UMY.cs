...
namespace ServiceRest_20190140130_MuhammadAnshoriAkbar
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=MSI;Initial Catalog=\"TIUMY\";Persist Security Info=True; User ID=sa;Password=anshori123");
        ...
        public List<Mahasiswa> GetAllMahasiswa()
        {
            ...
            SqlConnection con = new SqlConnection("Data Source=MSI;Initial Catalog=\"TIUMY\";Persist Security Info=True;User ID=sa;Password=anshori123");
